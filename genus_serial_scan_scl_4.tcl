...
check_dft_rules > /home/user01/riscv_testability/outputs/scl_4.rpt
...
report_scan_chains > /home/user01/riscv_testability/outputs/serial_scan/scan_chains_scl_4.rpt
...
# 16. Write netlist
write_hdl > /home/user01/riscv_testability/outputs/serial_scan/op_netlist_sdc/serialscan_scl_4.v

# 17. Write SDC
write_sdc > /home/user01/riscv_testability/outputs/serial_scan/op_netlist_sdc/serialscan_scl_4.sdc

# 18. Write SDF
write_sdf -nonegchecks -edges check_edge -timescale ns -recrem split -setuphold split > /home/user01/riscv_testability/outputs/serial_scan/op_netlist_sdc/serialscan_scl_4.sdf

# 19. Write SCANDEF
write_scandef > /home/user01/riscv_testability/outputs/serial_scan/serialscan_scanDEF_scl_4.scandef

# 20. Reports
report_area > /home/user01/riscv_testability/outputs/serial_scan/area_scl_4.rpt
report_gates > /home/user01/riscv_testability/outputs/serial_scan/gates_scl_4.rpt
report_qor > /home/user01/riscv_testability/outputs/serial_scan/qor_scl_4.rpt
report_timing > /home/user01/riscv_testability/outputs/serial_scan/timing_scl_4.rpt
